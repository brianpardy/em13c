...
echo -ne "\n\t(4d) *NEW* OMS HOME ($OMS_HOME) FIX HASHCODE IN ROOT_DISPATCHER (SYSTEM PATCH) (25315582)... "
omspatchercheck OMS $OMS_HOME 25315582

echo -ne "\n\t(4d) *NEW* OMS HOME ($OMS_HOME) TRACKING BUG TO REGISTER META VERSION FROM PS4 AND 13.1 BUNDLE PATCHES IN 13.2 (SYSTEM PATCH) (23603592)... "
...
#echo -ne "\n\t(4d) *NEW* OMS HOME ($OMS_HOME) MERGE REQUEST ON TOP OF 12.1.3.0.0 FOR BUGS 19485414 20022048 (21849941)... "
#omspatchercheck OMS $OMS_HOME 21849941
#
echo -ne "\n\t(4d) *NEW* OMS HOME ($OMS_HOME) MERGE REQUEST ON TOP OF 12.1.3.0.0 FOR BUGS 24571979 24335626 (25322055)... "
omspatchercheck OMS $OMS_HOME 25322055

echo -ne "\n\t(4d) *NEW* OMS HOME ($OMS_HOME) MERGE REQUEST ON TOP OF 12.1.3.0.0 FOR BUGS 22557350 19901079 20222451 (24329181)... "
omspatchercheck OMS $OMS_HOME 24329181

echo -ne "\n\t(4d) *NEW* OMS HOME ($OMS_HOME) OPSS-OPC Bundle Patch 12.1.3.0.170117 (25221285)... "
